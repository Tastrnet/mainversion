...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!birthYear || birthYear.trim() === "") {
      toast({
        title: "Error",
        description: "Birth year is required",
        variant: "destructive"
      });
      return;
    }
    ...
    if (isNaN(year)) {
      toast({
        title: "Error",
        description: "Birth year must be a valid number",
        variant: "destructive"
      });
      return;
    }

    // Validate it's after 1900
    if (year <= 1900) {
      toast({
        title: "Error",
        description: "Birth year must be after 1900",
        variant: "destructive"
      });
      return;
    }
    ...
    if (year > currentYear) {
      toast({
        title: "Error",
        description: "Birth year cannot be in the future",
        variant: "destructive"
      });
      return;
    }
